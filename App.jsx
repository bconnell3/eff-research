...
const ALL = [
    ...
    },
  {
      ...
      tier: "available",
      lastBefore: "Jul 10–11 – St. Paul, MN",
      firstAfter: "Sep 17–19 – Pryor, OK (festival)",
      notes: "Nearly 2-month open window. Emerging Montana indie folk duo — Frankie Cassidy and Nathan Ross, Arista Records, debut EP and early singles gaining traction. Aug 6–9 is clear. Caveat: currently playing club/theater scale (House of Blues, Crocodile, Irving Plaza) — discovery slot or smaller stage rather than main stage.",
    },
  {
